...
def plot():
    MayorCrecimiento = gapminder[
        gapminder["country"].isin(
            ["Singapore", "Taiwan", "Korea, Rep.", "Botswana", "Equatorial Guinea"]
        )
    ]
    ...
    figura = (
        ...
        .add(
            so.Line(color="gray", linestyle=(4, 3)),
            so.Agg(),
            data=gapminder,
            x="year",
            y="gdpPercap",
        ...
        .label(
            title="Top 5 paises con el mayor creciento periodo 1952-2007",
            y="PBI per Capita",
            x="Year",
        )
    )
